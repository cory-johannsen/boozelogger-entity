...
ALTER TABLE IF EXISTS ferment ADD CONSTRAINT ferment_log_fk FOREIGN KEY (ferment_log_id) REFERENCES ferment_log (id);

ALTER TABLE IF EXISTS distillation ADD CONSTRAINT distillation_log_fk FOREIGN KEY (distillation_log_id) REFERENCES distillation_log (id);
ALTER TABLE IF EXISTS distillation ADD CONSTRAINT ferment_fk FOREIGN KEY (ferment_id) REFERENCES ferment (id);

ALTER TABLE IF EXISTS finish ADD CONSTRAINT finish_log_fk FOREIGN KEY (finish_log_id) REFERENCES finish_log (id);
